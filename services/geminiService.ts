...
// This relies on the 'API_KEY' environment variable being set in your deployment (e.g., Vercel, Netlify)
// On Vercel: Go to Settings -> Environment Variables -> Add 'API_KEY'
